...
<html lang="{{ app()->getLocale() }}">
    ...
    @endphp
<div class='box box-4'>
 <button type="button" class="layui-btn layui-btn-danger layui-btn-sm" id="bu1" url="{{url('savesale')}}"><i class="layui-icon">保存&nbsp;&#xe621;</i></button>
    ...
    @endif
     <button type="button" class="layui-btn layui-btn-sm  layui-btn-normal" id="bu5" title="重置" url="{{url('resale')}}"><i class="layui-icon">&#xe669;</i></button>

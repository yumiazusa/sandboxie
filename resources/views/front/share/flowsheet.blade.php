      ...
      $(go.Palette, "myPaletteDiv",  // must name or refer to the DIV HTML element
        {
          ...
          model: new go.GraphLinksModel([  // specify the contents of the Palette
            ...
            { text: "人员" },
            { text: "动作", figure: "Diamond" },
            { category: "Comment", text: "单据" },
...
<body onLoad="init()">
<button type="button" class="layui-btn layui-btn-sm  layui-btn-normal" id="bu1" title="返回首页" style="margin:0 0 2px 92%"><i class="layui-icon">&#xe68e;返回首页</i></button>
<div id="sample" style="margin-left: 2%">
